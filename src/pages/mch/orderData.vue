...
const state=reactive({
  isShowData: localStorage.getItem('showMchOrderStatistics') ? JSON.parse(localStorage.getItem('showMchOrderStatistics')) : false,
...
watch(() => state.isShowData, (val) => {
  localStorage.setItem('showMchOrderStatistics', JSON.stringify(val))
})
...
<template>
  <a-flex vertical :gap="10" style="width: 100%;height: 100%">
    ...
    <order-statistics v-model:isShow="state.isShowData" :type="OrderStatisticsEnum.merchant"></order-statistics>
