...
const state=reactive({
  isShowData: localStorage.getItem('showAgentOrderStatistics') ? JSON.parse(localStorage.getItem('showAgentOrderStatistics')) : false,
...
watch(() => state.isShowData, (val) => {
  localStorage.setItem('showAgentOrderStatistics', JSON.stringify(val))
})
...
<template>
  <a-flex vertical :gap="10" style="width: 100%;height: 100%">
    ...
    <order-statistics v-model:isShow="state.isShowData" :type="OrderStatisticsEnum.agent"></order-statistics>
    <a-card >
